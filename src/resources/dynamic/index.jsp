    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <c:forEach items="${groups}" var="group">
                                        <li><a href="#" onclick="delete_group(${group.id})">${group.name}</a></li>
                                    </c:forEach>
                                </ul>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Count <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <c:forEach var="i" begin="2" end="20">
                                        <li><a href="/contact/count?count=${i}">${i}</a></li>
                                    </c:forEach>
                                </ul>
                            </li>
                        </ul>
        ...
        <script>
            ...
            function pag() {
                ...
                var n = href.indexOf("=", 0);
                console.log(n);
                var number = href.substr(n+1);
                if (n == -1 || number == 0) {
                    $(".pagination > li:first").css({"display": "none"});
                }
                if (number == "${pages-1}") {
                    $(".pagination > li:last").css({"display": "none"});
                }
                if (number.length > 3){
                    number = 0;
                }
                var selector = ".pagination li:nth-child(" + (+number+2) + ") > a";
                console.log(selector);
                $(selector).css({"background-color":"#b1bdd6"});
                $(".pagination > li:first > a").attr({"href": "/?page=" + (+number-1)});
                $(".pagination > li:last > a").attr({"href": "/?page=" + (+number + 1)});
            }
